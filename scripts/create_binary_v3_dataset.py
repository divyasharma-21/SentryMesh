...
def sample_uci_data():
    ...
    uci_legitimate = make_binary_labels(
        uci_legitimate
    )

    uci_suspicious = make_binary_labels(
        uci_suspicious
    )

    return uci_legitimate, uci_suspicious
...
def main():
    ...
    print("\nBinary V3 dataset created successfully.")
    print("Saved to:")
    print(OUTPUT_PATH)
    ...
    print("\nDistribution by channel and label:")
    print(
        pd.crosstab(
            dataframe["channel"],
            dataframe["label"]
