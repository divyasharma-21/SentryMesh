...
METRICS_PATH = (
    REPORTS_DIR
    / "sentrymesh_binary_tfidf_v1_metrics.json"
)

CONFUSION_MATRIX_PATH = (
    REPORTS_DIR
    / "sentrymesh_binary_tfidf_v1_confusion_matrix.png"
)

WRONG_PREDICTIONS_PATH = (
    REPORTS_DIR
    / "sentrymesh_binary_tfidf_v1_wrong_predictions.csv"
)
...
def main():
    ...
    metrics = {
        "model_name": "sentrymesh_binary_tfidf_v1",
